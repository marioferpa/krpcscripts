print "Importing ListedColormap,",
...
def animate(i):
    ...
    if parts != parts_i and booster_sep == False:
        booster_sep = True
        event = pd.DataFrame([[h_distance, altitude()/1000, "Booster separation"]], columns = ["Horizontal distance", "Altitude", "Name"])
        happenings = happenings.append(event)

    elif parts != parts_i and booster_sep == True and MECO == False:
        MECO = True
        event = pd.DataFrame([[h_distance, altitude()/1000, "MECO"]], columns = ["Horizontal distance", "Altitude", "Name"])
        happenings = happenings.append(event)

    elif parts != parts_i and booster_sep == True and MECO == True and SECO == False:
        SECO = True
        event = pd.DataFrame([[h_distance, altitude()/1000, "SECO"]], columns = ["Horizontal distance", "Altitude", "Name"])
        happenings = happenings.append(event)
